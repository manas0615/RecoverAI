import inspect
from recoverai.evaluation.simulator import SyntheticScenarioGenerator, ObservableCaseEvidence, HiddenOutcomeTruth
...
def test_changing_l2_cannot_silently_change_oracle():
    ...
    original_decision = scenarios[0].oracle.expected_decision
