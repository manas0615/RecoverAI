...
from recoverai.evaluation.strategies import L2DeterministicRules, L3CurrentRecoverAI, L3ControlledAIRecoverAI
...
if __name__ == "__main__":
    ...
    print("--- L2 ---")
    print(f"Gross Recovery: {m2.gross_recovered_value} | Policy Viol: {m2.policy_violations} | Oracle Agrmnt: {m2.decision_quality_rate * 100:.1f}%")
    print("--- L3-F ---")
    print(f"Gross Recovery: {m3f.gross_recovered_value} | Policy Viol: {m3f.policy_violations} | Oracle Agrmnt: {m3f.decision_quality_rate * 100:.1f}%")
    print("--- L3-A ---")
    print(f"Gross Recovery: {m3a.gross_recovered_value} | Policy Viol: {m3a.policy_violations} | Oracle Agrmnt: {m3a.decision_quality_rate * 100:.1f}%")
    print("\n--- AI ATTRIBUTION ---")
